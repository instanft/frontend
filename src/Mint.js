    ...
    return (
      <div>
        ...
        <div
          ...
          onClick={this.pushImageToIPFS}
        />
        <p>
          {this.state.metadata !== {} ? this.state.metadata.ipfs : null}
        </p>
        <form>
          <input placeholder="Copy/paste your Instagram post URL..." />
          <button
            type="submit"
            onSubmit={mintInstagramPost(this.state.metadata)}
          >
            Mint
          </button>
        </form>
